...
const TestimonialSlider: React.FC = () => {
    ...
    return (
        <section id="testim" className="testim">
            <div className="wrap">
                <span id="right-arrow" className="arrow right fa fa-chevron-right" onClick={handleNextSlide}></span>
                <span id="left-arrow" className="arrow left fa fa-chevron-left" onClick={handlePrevSlide}></span>
                    ...
                    <div id="testim-content" className="cont">
                        ...
                        {testimonials.map((testimonial, index) => (
                            <div key={index} className={index === currentSlide ? 'active' : ''}>
                                ...
                                <p className='flex  h-[10rem]  w-[20rem] sm:w-[40vw] sm:h-[50vh]'>
                                    {/* {icons.feedbackBox} */}
                                    <Image src={testimonial?.feedbackImg} layout='fill' alt={testimonial.name} />
                                </p>
                                <div className="img my-[1rem]">
                                    <Image src={testimonial?.imageSrc}
                                        width={50} height={50} alt={testimonial.name} />
                                </div>
